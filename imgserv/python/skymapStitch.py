...
if __name__ == "__main__":
    ...
    # Alternate location for creating an image, which requires stitching across
    # tract boundaries and warping.
    #raA = afwGeom.Angle(0.0, afwGeom.degrees)
    #decA = afwGeom.Angle(0.01667, afwGeom.degrees)
    #ctrCoord = afwCoord.Coord(raA, decA, 2000.0)

    # Image created by following is within a single tract, no warping required.
